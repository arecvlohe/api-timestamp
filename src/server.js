...
function handleResponse(req, res) {
  ...
  if (obj.pathname === '/')
    response =
      `This is an API timestamp service. Call the API using /api/parsetime or /api/unixtime. For example : /api/parsetime?iso=2013-08-10T12:10:15.474Z. For parsetime you will receive: { "hour":12, "minute":10, "second":15 }. For unixtime you will receive: { "unix":1376136615474 }. For an invalid ISO 8601 format you will receive: { error: 'Invalid ISO-format' }. For any questions contact Adam Recvlohe <adam.recvlohe@gmail.com>`;
